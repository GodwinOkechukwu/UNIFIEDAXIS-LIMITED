...
const CartModal = ({ isOpen, onClose }: CartModalProps) => {
  ...
  return createPortal(
    <>
      ...
      <div
        onClick={onClose}
        className={`fixed inset-0 z-[998] bg-black backdrop-blur-sm transition-opacity duration-350 ${
...
const Header = () => {
  ...
  return (
    <>
      <header className="flex flex-col w-full bg-[#0D1C2D99] z-[100] fixed top-0 border-b border-[#5F3E3E33] shadow-2xl transition-all">
        {/* Desktop Header */}
        <div
        ...
        >
          ...
          <div className="col-span-1 flex items-center justify-end gap-6">
            {showSearch && (
              <div className="col-span-1 flex justify-center ">
                <div className="relative w-full max-w-[550px] group">
                  <FiSearch className="absolute left-4 top-1/2 -translate-y-1/2 text-[#CBC3D7] group-focus-within:text-blue-500 transition-colors" />
                  <input
                    type="text"
            ...
            <FiSearch
              ...
              className="relative cursor-pointer top-[10px] -translate-y-1/2 text-[#CBC3D7] group-focus-within:text-blue-500 transition-colors"
            />
            ...
            <div className="relative cursor-pointer group" onClick={onOpenCart}>
              <MdShoppingCart className="text-2xl text-[#CBC3D7] group-hover:text-[#CBC3D7]/90 transition" />
              {totalItems > 0 && (
            ...
            {email ? (
              ...
              <div className="relative inline-block text-left">
                <CircleUser className="text-[#CBC3D7]" fill="white" />
              </div>
            )}
          </div>
        </div>
        ...
        <div className="slg:hidden flex flex-col w-full p-4 gap-3 bg-[#0D1C2D99]">
          <div className="flex items-center justify-between">
            ...
            <div onClick={onOpenCart} className="relative">
              <MdShoppingCart className="text-2xl text-[#CBC3D7]" />
              {totalItems > 0 && (
          ...
          <div className="relative h-10">
            <input
              ...
              className="w-full h-full text-sm bg-gray-300 rounded-lg px-4 border-none outline-none focus:ring-2 focus:ring-primary-100"
              value={searchValue}
              onChange={(e) => setSearchValue(e.target.value)}
              onKeyDown={(e) => e.key === "Enter" && handleSearch()}
            />
            {isPending ? (
              ...
              <FiSearch className="absolute right-3 top-1/2 -translate-y-1/2 text-[#CBC3D7]" />
            )}
          </div>
        </div>
