...
export const SITE_NAME = "Unifiedaxis Limited";
export const SITE_URL =
  process.env.NEXT_PUBLIC_SITE_URL ||
  "http://unifiedaxis-limited.com"; // Update with actual URL
export const TWITTER_HANDLE = "@unifiedaxis";
...
export const SEODATA: Record<string, SEOConfig> = {
  ...
  home: {
    ...
    description:
      "Innovate and grow with unifiedaxis. We build high-performance digital products, from mobile apps to enterprise AI systems, tailored to your business needs.",
    keywords: [
  ...
  login: {
    ...
    description:
      "Access your unifiedaxis client dashboard to track project progress, manage subscriptions, and collaborate with your dev team.",
    keywords: [
      "Client login",
      "Project tracking portal",
      "unifiedaxis dashboard access",
    ],
  },
  register: {
    title: `Partner with Us | Join ${SITE_NAME}`,
    description:
      "Create an account to start your project journey with Unifiedaxis Limited and access premium tech resources.",
    keywords: [
      "Get started with unifiedaxis",
      "Project onboarding",
      "Digital partnership",
    ],
  },
